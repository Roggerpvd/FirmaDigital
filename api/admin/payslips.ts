// api/admin/payslips.ts
//
// Un solo endpoint que cubre todo lo relacionado a boletas desde el panel de
// admin (para no pasarnos del límite de Serverless Functions del plan Hobby
// de Vercel):
//   GET  /api/admin/payslips                          -> lista todas las boletas
//   GET  /api/admin/payslips?payslipCode=X             -> descarga el PDF original
//   GET  /api/admin/payslips?payslipCode=X&signed=true -> descarga el PDF firmado
//   POST /api/admin/payslips                          -> crea una boleta subiendo su PDF
